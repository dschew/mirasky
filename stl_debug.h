...
#if defined STL_DEBUG_SERIAL_PORT
    #define STL_SERIAL_DEBUG
    #define STL_DEBUG_TYPE          avr_uart
#endif // STL_*_SERIAL_PORT

// This section enables debugging through a MaxStream 9XStream series radio modem
#ifdef STL_DEBUG_9XSTREAM
    #define STL_SERIAL_DEBUG
    #define STL_DEBUG_TYPE          avr_9xstream
#endif // STL_*_9XSTREAM

// This section enables state transition tracing through a wired serial port
#if defined STL_TRACE_SERIAL_PORT
    #define STL_SERIAL_TRACE
    #define STL_DEBUG_TYPE          avr_uart
#endif // STL_TRACE_SERIAL_PORT

// This section enables state transition tracing through a wired serial port
    #if defined STL_TRACE_9XSTREAM
    #define STL_SERIAL_TRACE
    #define STL_DEBUG_TYPE          avr_9xstream
#endif // STL_TRACE_9XSTREAM
...
// Common macros that are used for all serial debugging methods
    ...
    #define STL_DEBUG_WRITE(x)     if (dbg_port) dbg_port->write (x)
    #define STL_DEBUG_WRITE_HEX(x) if (dbg_port) dbg_port->write (x)
...
// Common macros that are used for all serial state transition tracing methods
    ...
    #define STL_TRACE_WRITE(x)     if (dbg_port) dbg_port->write (x)
#endif // STL_SERIAL_DEBUG
